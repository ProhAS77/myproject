...
class UserForm(forms.Form):
    ...
    def clean_name(self):
        #Плохой пример. Подмета параментра min_length
    ...
    def clean_email(self):
        ...
        if not (email.endswith('vk.com') or email.endswith('corp.mail.ru')):
            raise forms.ValidationError('Используйте корпоративную почту (vk.com/corp.mail.ru)')
        return email
